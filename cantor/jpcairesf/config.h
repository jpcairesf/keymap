...
// When enabled, typing a mod-tap plus second within term will register as the
// mod-combo Ref:
...
// Set the COMBO_TERM so low that I won't type the keys one after each other
// during normal typing. They would have be held together intentionally to
// trigger this.
...
// I want a relatively low timeout, so if I accidentally type "Shift", I can
// pause just briefly and move on.
#define ONESHOT_TAP_TOGGLE                                                     \
    3 /* Tapping this number of times holds the key until tapped once again.   \
       */
